...
QGIS_PREFIX_PATH=/home/richard/bin/qgis_all/2.14/debug
if [ -n "$1" ]; then
    QGIS_PREFIX_PATH=$1
fi
...
export LD_LIBRARY_PATH=${QGIS_PREFIX_PATH}/lib:/usr/lib
export PYTHONPATH=${QGIS_PREFIX_PATH}/share/qgis/python:${QGIS_PREFIX_PATH}/share/qgis/python/plugins:${PLUGIN_MODULES}:${PYTHON_PATH}

echo "QGIS PATH: $QGIS_PREFIX_PATH"
export QGIS_DEBUG=0
export QGIS_LOG_FILE=/tmp/qgis_rivmpluginconfigmanager.log
